...
const Admissions = () => {
  return (
    <section className="experience-grid">
      ...
      <div className="experience-grid-portraitpic-item"></div>
      <div className="experience-grid-landscape-item"></div>
      <div className="experience-grid-littlepic-item"></div>
      <div className="experience-grid-littlepic1-item"> </div>
    </section>
  );
};
